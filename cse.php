...
<form method="POST" action="insert.php" enctype="multipart/form-data">
		<div>
			...
			<input type="hidden" name="t7" value="cse" required/><br>
		...
		<input type="checkbox" name="c3" value="html">&nbsp;<span>HTML</span><br>
		<input type="checkbox" name="c4" value="javascript">&nbsp;<span>JAVASCRIPT</span><br>
		<input type="checkbox" name="c5" value="php">&nbsp;<span>PHP</span><br>
		<input type="checkbox" name="c6" value="oracle">&nbsp;<span>ORACLE</span><br><br>
