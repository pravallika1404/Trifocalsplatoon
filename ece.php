...
<form method="POST" action="insert.php" enctype="multipart/form-data">
		<div>
			...
			<input type="hidden" name="t7" value="ece" required/><br>
		...
		<input type="checkbox" name="c2" value="ds">&nbsp;<span>DATA STRUCTUERS</span><br>
		<input type="checkbox" name="c3" value="digitalcommunication">&nbsp;<span>DIGITAL COMMUNICATION</span><br>
		<input type="checkbox" name="c4" value="microprocessors">&nbsp;<span>MICROPROCESSORS</span><br>
		<input type="checkbox" name="c5" value="basicelectronics">&nbsp;<span>BASIC ELECTRONICS</span><br>
		<input type="checkbox" name="c6" value="vlsi">&nbsp;<span>VLSI</span><br><br>
