...
<form method="POST" action="insert.php" enctype="multipart/form-data">
		<div>
			...
			<input type="hidden" name="t7" value="mech" required/><br>
		...
		<input type="checkbox" name="c2" value="progecad">&nbsp;<span>PROGECAD</span><br>
		<input type="checkbox" name="c3" value="solidworks">&nbsp;<span>SOLIDWORKS</span><br>
		<input type="checkbox" name="c4" value="strenth of material">&nbsp;<span>STRENGTH OF MATERIAL</span><br>
		<input type="checkbox" name="c5" value="thermodynamics">&nbsp;<span>THERMODYNAMICS</span><br>
		<input type="checkbox" name="c6" value="fluid mechanics">&nbsp;<span>FLUID MECHANICS</span><br><br>
