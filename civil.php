...
<form method="POST" action="insert.php" enctype="multipart/form-data">
		<div>
			...
			<input type="hidden" name="t7" value="civil" required/><br>
		...
		<input type="checkbox" name="c2" value="concrete technology">&nbsp;<span>CONCRETE TECHNOLOGY</span><br>
		<input type="checkbox" name="c3" value="mechanics">&nbsp;<span>MECHANICS</span><br>
		<input type="checkbox" name="c4" value="auto cad">&nbsp;<span>AUTO CAD</span><br>
		<input type="checkbox" name="c5" value="stadpro">&nbsp;<span>STADPRO</span><br>
		<input type="checkbox" name="c6" value="geotechnical engineering">&nbsp;<span>GEOTECHNICAL ENGINEERING</span><br><br>
